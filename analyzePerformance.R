#Read data
swissprot <- read.csv("Übung03/pp2_2017-11-20/results/swissprot_filtered.tsv", sep="\t", header=TRUE)
hpa <- read.csv("Übung03/pp2_2017-11-20/results/hpa_filtered.tsv", sep="\t", header=TRUE)
deeploc <- read.csv("Übung03/pp2_2017-11-20/results/deeploc_filtered.tsv", sep="\t", header=TRUE)

#Read mapping + merge mapping with SwissProt & HPA
mapping <- read.csv("Übung03/pp2_2017-11-20/results/location_mapping.tsv", sep="\t", header=TRUE)
